...
class LibraryCallgraphBuilderTest extends AnyFlatSpec with must.Matchers {
  ...
  private val identifier1: MavenIdentifier =
    MavenIdentifier("love.forte.simple-robot", "api", "2.3.0")
  private val identifier2: MavenIdentifier =
    MavenIdentifier("com.librato.metrics", "metrics-librato", "5.1.4")
  private val identifier3: MavenIdentifier =
    MavenIdentifier("com.typesafe.akka", "akka-actor_2.12", "2.6.17")
  private val identifier4: MavenIdentifier =
    MavenIdentifier("com.google.code.gson", "gson", "2.8.9")

  private val identifier5: MavenIdentifier =
    MavenIdentifier("com.fasterxml.jackson.core", "jackson-databind", "2.13.0")

  "The library callgraph builder" must "process two recent releases of jackson-databind" in {
    val evolution = buildEvolutionForArtifacts(MavenIdentifier("com.fasterxml.jackson.core", "jackson-databind", "2.12.5"), identifier5)
