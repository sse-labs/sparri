...
import com.sksamuel.elastic4s.ElasticApi.{RichFuture, boolQuery, search, searchScroll, termQuery}
...
class MethodDataAccessor(config: Configuration)(implicit system: ActorSystem) {
