package org.anon.spareuse.eval.formats

import org.anon.spareuse.core.formats.{AnalysisResultFormat, GraphResultFormat, ListResultFormat, MapResultFormat, NamedPropertyFormat, NumberFormat, ObjectResultFormat, StringFormat}
